          ...
          <div className="space-y-8 animate-slide-in-left">
            ...
            <div className="flex items-center space-x-8 pt-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-white gradient-text">8+</div>
                <div className="text-gray-300 text-sm">Yıl Deneyim</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white gradient-text">150+</div>
                <div className="text-gray-300 text-sm">Proje</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white gradient-text">100%</div>
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl hover-lift">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                    <h3 className="text-white font-bold text-lg mb-2">Yaratıcı Ekibimiz</h3>
                    <p className="text-gray-200 text-sm">Dijital dünyada fark yaratan projeler üretiyoruz</p>
                  </div>
                </div>
              </div>
            </div>
